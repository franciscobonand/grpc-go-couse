...
type BlogServiceClient interface {
	...
	UpdadeBlog(ctx context.Context, in *Blog, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *blogServiceClient) UpdadeBlog(ctx context.Context, in *Blog, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/blog.BlogService/UpdadeBlog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlogServiceServer interface {
	...
	UpdadeBlog(context.Context, *Blog) (*emptypb.Empty, error)
...
func (UnimplementedBlogServiceServer) UpdadeBlog(context.Context, *Blog) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdadeBlog not implemented")
}
...
func _BlogService_UpdadeBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Blog)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServiceServer).UpdadeBlog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.BlogService/UpdadeBlog",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).UpdadeBlog(ctx, req.(*Blog))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdadeBlog",
			Handler:    _BlogService_UpdadeBlog_Handler,
		},
		{
